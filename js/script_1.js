...
function Login(){
    ...
    x.setAttribute('src','Login.html');
}

function Ingresar(){
    var id="Emanuel";
    var pass="123";
    var cajaid=document.getElementById("email").value;
    var cajapass=document.getElementById("password").value;
    
    if(id==cajaid && pass==cajapass){
